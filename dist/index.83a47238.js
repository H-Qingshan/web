...
const player = {
    ...
    n: 1,
    init: ()=>{
        player.ui.demo.innerHTML = String.substr(0, player.n), player.ui.demo2.innerText = String.substr(0, player.n), player.play(), player.bindEvents();
    },
    events: {
        '#btnPause': 'pause',
        '#btnPlay': 'play',
    ...
    run: ()=>{
        ...
        player.ui.demo.innerHTML = String.substr(0, player.n), player.ui.demo2.innerText = String.substr(0, player.n), player.ui.demo2.scrollTop = demo2.scrollHeight;
    },
    play: ()=>{
